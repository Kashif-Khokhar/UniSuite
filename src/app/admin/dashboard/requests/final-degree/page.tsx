...
export default function AdminFinalDegreePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-800">Manage Final Degree</h1>
      ...
      <div className="flex min-h-[400px] flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 p-12 text-center">
        ...
        <p className="max-w-md text-sm text-slate-500">
          The administrative controls for Final Degree will be available in a future update. 
