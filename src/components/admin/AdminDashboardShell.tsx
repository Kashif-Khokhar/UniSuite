  ...
  return (
    <div className="flex min-h-screen bg-background">
           ...
           <div className="flex items-center gap-2">
             ...
             {sidebarOpen && (
               <div className="flex flex-col">
                 ...
                 <span className="text-[10px] font-bold text-brand-500 tracking-widest uppercase">Admin</span>
               </div>
             )}
           </div>
        </div>
      ...
      <div className="flex min-h-screen flex-1 flex-col min-w-0">
                ...
                <div className="absolute right-0 top-full mt-2 w-80 rounded-2xl bg-white shadow-xl border border-slate-100 overflow-hidden z-50">
                  ...
                  <div className="flex flex-col max-h-[400px] overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-1 px-5 py-4 border-b border-slate-50 hover:bg-slate-50 transition-colors cursor-pointer">
                      <p className="font-medium text-[#e07a5f]">Heavy Rain Warning</p>
                      <p className="text-sm text-slate-500 leading-relaxed">
                        Meteorological data suggests heavy rainfall in your region over the next 48 hours.
                      </p>
                      <p className="text-sm font-medium text-[#e07a5f] mt-1">2 hours ago</p>
                    </div>
                    {/* Notification Item 2 */}
                    <div className="flex flex-col gap-1 px-5 py-4 hover:bg-slate-50 transition-colors cursor-pointer">
                      <p className="font-medium text-slate-800">Course Analysis Complete</p>
                      <p className="text-sm text-slate-500 leading-relaxed">
                        Your recent CS-101 course evaluation scan shows 92% satisfaction.
                      </p>
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 rounded-xl bg-white shadow-lg border border-slate-100 overflow-hidden z-50">
                  <div className="px-4 py-3 border-b border-slate-100">
                    ...
                    <p className="text-xs text-slate-500 truncate mt-0.5">Administrator</p>
                  </div>
                  <div className="py-1">
                    <Link 
        ...
        {/* <AdminBreadcrumbs /> - hiding it to match the clean design but can keep it if needed */}
